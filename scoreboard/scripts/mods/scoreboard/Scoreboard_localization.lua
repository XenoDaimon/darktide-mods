...
mod:add_global_localize_strings({
	...
	loc_scoreboard_delete = {
		...
		fr = "Supprimer le tableau des scores",
...
return {
	...
	row_forge_material = {
		...
		fr = "Métaux / Diamantine collectés",
	...
	row_carrying = {
		...
		fr = "Écritures Saintes / Grimoires / Autres transportés",
	...
	plugin_damage_taken_heal_station_used = {
		...
		fr = "Dommages Subis / Stations de soin utilisées",
	...
	plugin_special_hits = {
		...
		fr = "Coups portés aux Points Faibles / Critiques",
	...
	plugin_health_ammo_placed = {
		...
		fr = "Caisses de soin / Caisses de munitions déployés",
	...
	ammo_health_pickup = {
		...
		fr = "Caisse de soin / Caisse de munitions récupérées",
	...
	scripture_grimoire_pickup = {
		...
		fr = "Écrits saints / Grimoires récupérés",
	...
	scripture_grimoire_pickup_description = {
		...
		fr = "Affiche un message lorsqu'un joueur ramasse un écrit saint ou un grimoire",
